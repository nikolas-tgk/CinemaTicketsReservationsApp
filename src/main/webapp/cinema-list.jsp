			...
			<table class="table table-bordered">
				<thead>
					<tr>
						...
						<th>Address</th>
						<th>Provider</th>
						<th><a href="contentadmin?action=newcinema" class="btn btn-success">Add Cinema</a></th>
					</tr>
				</thead>
				<tbody>					
					<c:forEach var="cinema" items="${cinemaList}">
						<tr>
							<td><c:out value="${cinema.getName()}"/></td>
							<td><c:out value="${cinema.getAddress()}"/></td>
							<td><c:out value="${cinema.getProvider()}"/></td>
							<td><a
								href="contentadmin?action=removecinema&name=<c:out value='${cinema.getName()}' />">Delete</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>
